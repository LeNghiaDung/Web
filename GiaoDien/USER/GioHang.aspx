<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GioHang.aspx.cs" Inherits="BTLWEB.GiaoDien.USER.GioHang" %>
...
<body>
    ...
    <section id="cart_category">
        <h1>LỊCH SỬ <strong>MUA HÀNG</strong></h1>
        <div class="category_button">
            <button type="button" class="button_focus">
                <p class="category_text">Giỏ hàng</p>
            </button>
            <button type="button" class="button" onclick="">
                <p class="category_text">Lịch sử mua hàng</p>
            </button>
        </div>
    </section>
    ...
    <section id="cart_add">
        <div id="total">
            ...
            <button id="btnTiepTucMua" class="btnTiepTucMua">Tiếp tục mua hàng</button>
        </div>
    </section>
