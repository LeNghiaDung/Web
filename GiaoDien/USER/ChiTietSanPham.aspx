<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChiTietSanPham.aspx.cs" Inherits="BTLWEB.GiaoDien.ChiTietSanPham" %>
        ...
        <header class="header">
            ...
            <div class="menu">
                <ul id="navbar">
                    ...
                    <li><a href="../TrangDanhMuc/productList.html">Sản phẩm</a></li>
            ...
            <div class="search">
                <div class="search-bar">
                    <input id="search" runat ="server" placeholder="Tìm kiếm sản phẩm..." type="text"/>
                    <asp:Button ID="ButtonSearch" CssClass="btnSearch" runat="server" Text="Tìm Kiếm" OnClick="btnSearch_click" />
                </div> 
            </div>
            <div id="user">
                <div class="avatar">
                ...
                <div class="cart_icon" onclick="Location">
                    <a href="DangNhap.aspx"><svg style="width: 20px; height: 20px;"
